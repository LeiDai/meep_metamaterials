...
## Create fields with Bloch-periodic boundaries (any nonzero transversal component of k-vector possible)
f = meep.fields(s)
...
#slice_makers = [meep_utils.SliceMaker(field=f, component=meep.Hy, timestep=1e-12, normal="x", 
    #position=0., model=model, outputdir=model.simulation_name, pad=model.pml_thickness)]
slice_makers = []
